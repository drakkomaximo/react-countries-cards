      ...
      <div className="flex flex-wrap max-w-7xl justify-between">
        {country && (
          <CountryDescription
            ...
            currencies={country[0]?.currencies ? [Object.values(country[0]?.currencies)[0].name] : [Dictionary.DOESNOTHAVE]}
            languages={country[0]?.languages ? [Object.values(country[0]?.languages).join(', ')] : [Dictionary.DOESNOTHAVE]}
            nativeName={country[0]?.name?.nativeName ? Object.values(country[0]?.name?.nativeName)[0].common : Dictionary.DOESNOTHAVE}
